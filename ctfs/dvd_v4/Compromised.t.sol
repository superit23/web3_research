...
contract Exploit is IERC721Receiver{
    ...
    Exchange immutable exchange;
    DamnValuableNFT immutable token;
    address immutable recovery;

    uint256 nftId;

    constructor(Exchange _exchange, DamnValuableNFT _token, address _recovery) payable {
        exchange = _exchange;
        token = _token;
        recovery = _recovery;
    }
...
contract CompromisedChallenge is Test {
    ...
    address[] sources = [
        0x188Ea627E3531Db590e6f1D71ED83628d1933088, // DANI EDIT: COMPROMISED in README
        0xA417D473c40a4d42BAd35f147c21eEa7973539D8, // DANI EDIT: COMPROMISED in README
    ...
    // Note this isn't checkedSolvedByPlayer ;)
